...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    public class ScaleController : MonoBehaviour
    {
        ...
        public void Update(){
            Vector3 scaleTmp = HandCollider.transform.localScale;
            scaleTmp.x = 0.1f/transform.localScale.x ;
            scaleTmp.y = 0.1f/transform.localScale.y;
            scaleTmp.z = 0.1f/transform.localScale.z;
            HandCollider.transform.localScale = scaleTmp;
        }
